...
public class StackSteps 
{
	...
	public void user_should_see_link_of_stack_page(String topicName) 
	{
		...
		case "Operations in Stack":
			assertTrue(stackPage.isOperationsInStackDisplayed(),
                    topicName + " link is NOT visible on Stack page");
            break;
        case "Implementation":
        	assertTrue(stackPage.isImplementationDisplayed(),
                    topicName + " link is NOT visible on Stack page");
            break;
        case "Applications":
        	assertTrue(stackPage.IsApplicationsDisplayed(),
                    topicName + " link is NOT visible on Stack page");
            break;
        default:
	...
	public void user_should_see_try_here_button_on_the_stack_page() {
		assertTrue(stackPage.isTryHereVisible(),
                "Try Here button not visible");
	}
	...
	public void user_should_be_directed_to_page_of_stack_page(String expectedPage) {
		 assertTrue(stackPage.isUrlContains(expectedPage),
