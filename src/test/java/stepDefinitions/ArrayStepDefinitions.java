...
public class ArrayStepDefinitions {
	...
	public void userClicksSearchTheArrayLinkInThePracticePageAndUserClearsTheTextInTheEditorArea() {
		arrayPage.clickSearchTheArray();
		arrayPage.clearEditorText();
	}

	@When("User enters the python code for the following {string} and User clicks Run button")
	public void userEntersThePythonCodeForTheFollowingAndUserClicksRunButton(String scenarioName) {
	...
	public void userClicksMaxConsecutiveOnesLinkInThePracticePageAndUserClearsTheTextInTheEditorArea() {
	...
	public void userClicksFindNumbersWithEvenNumberOfDigitsLinkInThePracticePageAndUserClearsTheTextInTheEditorArea() {
	...
	public void userClicksSquaresOfASortedArrayLinkInThePracticePageAndUserClearsTheTextInTheEditorArea() {
